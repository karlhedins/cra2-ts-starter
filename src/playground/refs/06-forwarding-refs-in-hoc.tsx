...
const withPropsLogger = <T extends Component, OriginalProps extends {}>(
  ...
  type Props = OriginalProps & IPrivateProps;
...
class FancyButton extends Component<IFancyButtonProps> {
...
const EnhancedFancyButton = withPropsLogger<FancyButton, IFancyButtonProps>(
  FancyButton
);
